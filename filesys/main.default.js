...
(function () {
	...
	var // jQuery and jQueryUI version
		...
		load = function () {
			require(
				[
					'elfinder'
					, '/filesys/js/extras/editors.default.min.js'               // load text, image editors
					, 'elFinderConfig'
	...
	require.config({
		...
		paths: {
			...
			'elfinder': '/filesys/js/elfinder.min',
	...
	if (!require.defined('elFinderConfig')) {
		define('elFinderConfig', {
			...
			defaultOpts: {
				url: '/filesys/php/connector.minimal.php' // connector URL (REQUIRED)
				, commandsOptions: {
					edit: {
						extraOptions: {
